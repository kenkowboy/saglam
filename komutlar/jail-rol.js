...
if (!message.member.hasPermission('MANAGE_GUILD')) return message.reply(`**${ayarlar.prefix}jail-rol ayarla/sıfırla** İsimli Komutu Kullanabilmek İçin Yetkin Yetersiz.`)
if (!args[0]) return message.reply(`Komutu Kullanabilmek İçin, q!jail-rol ayarla/sıfırla @rol Yazmalısın.`)
